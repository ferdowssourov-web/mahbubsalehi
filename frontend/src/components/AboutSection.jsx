        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="font-body text-slate-600 text-lg leading-relaxed mb-6">
              ব্যারিস্টার মাহবুবুল আলম সালেহী একজন আন্তর্জাতিকভাবে স্বীকৃত অভিবাসন বিশেষজ্ঞ, মানবাধিকার আইনজীবী ও সমাজসেবক। তিনি কুড়িগ্রাম-৩ (উলিপুর) সংসদীয় আসনের সংসদ সদস্য।
            </p>
